...
const App: React.FC = () => {
  ...
  return (
    <div id="app-root" className="relative w-screen h-screen bg-black overflow-hidden flex flex-col items-center justify-center font-mono selection:bg-[#FF003C]">
      ...
      {/* HUD: SYSTEM STATUS */}
      <div id="hud-system-status" className="absolute top-8 left-8 flex flex-col gap-2 pointer-events-none z-40">
        ...
        <div id="score-display" className="text-7xl font-black text-white tracking-tighter drop-shadow-[0_0_10px_#E056FD]">
      ...
      {isDead && (
        <div id="sync-lost-overlay" className="absolute inset-0 bg-black/95 backdrop-blur-md z-[100] flex flex-col items-center justify-center animate-in fade-in duration-500">
          ...
          <button
            ...
            className="group flex items-center gap-4 px-16 py-6 bg-white text-black font-black text-2xl hover:bg-[#FF003C] hover:text-white transition-all uppercase tracking-widest shadow-[0_10px_40px_rgba(255,0,60,0.4)] cursor-pointer"
          >
